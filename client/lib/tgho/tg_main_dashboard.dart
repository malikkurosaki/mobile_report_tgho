                                                  ...
                                                  for (final i in TgUtilPref.reportByGroupX)
                                                    {
                                                      "domain": i['group'],
                                                      "measure": int.parse(
                                                          (i["data"]['year']['data']['_sum']['total'].toString() ==
                                                                      "null"
                                                                  ? "0"
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                        (i['data']['month']['data']['_sum']['total'] ?? 0).toString(),
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                    NumberFormat.currency(
                                                                            ...
                                                                            symbol: "Rp",
                                                                            decimalDigits: 0)
                                                                        .format(int.parse((i['data']['year']['data']
                                                                                    ['_sum']['total'] ??
                                                                                0)
                                                                            .toString())),
                                                                    style: TextStyle(
                                                          ...
                                                          data: [
                                                            {
                                                              ...
                                                              "data": [
                                                                for (final i in TgUtilPref.reportByDeptX)
                                                                  {
                                                                    "domain":
                                                                        i['dept'].toString().split(" ")[0].toString(),
                                                                    "measure": int.parse((i["data"]['year']['data']
                                                                                        ['_sum']['total']
                                                                                    .toString() ==
                                                                                "null"
                                                                            ? "0"
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    NumberFormat("#,###").format(int.tryParse(
                                                            i['data']['week']['data']['_sum']['total'].toString()) ??
                                                        0),
                                                    style: TextStyle(
                                                      fontSize: 20,
                                                      fontWeight: FontWeight.bold,
                                                  ...
                                                  Text(
                                                    NumberFormat("#,###").format(int.tryParse(
                                                            i['data']['day']['data']['_sum']['total'].toString()) ??
                                                        0),
                                                    style: TextStyle(
                                                      fontSize: 20,
                                                      fontWeight: FontWeight.bold,
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      DateFormat("dd MMMM yyyy").format(DateTime.parse(
                                                          TgUtilPref.productYearReportX['date']['start'].toString())),
                                                      style: TextStyle(
                                                          fontSize: 20,
                                                          fontWeight: FontWeight.bold,
                                                          color: Colors.grey),
                                                    ...
                                                    Text(
                                                      DateFormat("dd MMMM yyyy").format(DateTime.parse(
                                                          TgUtilPref.productYearReportX['date']['end'].toString())),
                                                      style: TextStyle(
                                                          fontSize: 20,
                                                          fontWeight: FontWeight.bold,
                                                          color: Colors.grey),
                                                    ...
                                                    data: [
                                                      {
                                                        ...
                                                        "data": [
                                                          for (final pie in TgUtilPref.productYearReportX['data'])
                                                            {
                                                              "domain":
                                                                  pie['nama_pro'].toString().split(" ")[0].toString(),
                                                              "measure":
                                              ...
                                              Wrap(
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    child: ListTile(
                                                      leading: Container(
                                                          height: 20, width: 20, color: Colors.blue.withOpacity(0.5)),
                                                      title: Text(
                                                        "Month",
                                                        style: TextStyle(
                                                            fontSize: 18,
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: ListTile(
                                                      leading: Container(
                                                          height: 20, width: 20, color: Colors.red.withOpacity(0.5)),
                                                      title: Text(
                                                        "Day",
                                                        style: TextStyle(
                                                            fontSize: 18,
