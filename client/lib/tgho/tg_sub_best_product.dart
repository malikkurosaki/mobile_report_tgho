...
class TgSubBestProduct extends StatelessWidget {
  const TgSubBestProduct({Key? key}) : super(key: key);
                                      ...
                                      Wrap(
                                        children: [
                                          SizedBox(
                                            ...
                                            child: ListTile(
                                              leading:
                                                  Container(height: 20, width: 20, color: Colors.blue.withOpacity(0.5)),
                                              title: Text(
                                                "Month",
                                                style: TextStyle(
                                          ...
                                          SizedBox(
                                            ...
                                            child: ListTile(
                                              leading: Container(
                                                  height: 20, width: 20, color: Colors.green.withOpacity(0.5)),
                                              title: Text(
                                                "Week",
                                                style: TextStyle(
                                                    fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey),
                                          ...
                                          SizedBox(
                                            ...
                                            child: ListTile(
                                              leading:
                                                  Container(height: 20, width: 20, color: Colors.red.withOpacity(0.5)),
                                              title: Text(
                                                "Day",
                                                style: TextStyle(
                                                    fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey),
                                                            ...
                                                            for (final pie in TgUtilPref.productMonthReportX['data'])
                                                              {
                                                                ...
                                                                "measure":
                                                                    int.tryParse(pie['totalValue'].toString()) ?? 0,
                                                              },
                                                          ]
                                                        },
                                                        {
