...
class ViewSalesPerformance extends StatelessWidget {
  final bool? animate;
  ViewSalesPerformance({Key? key, this.animate}) : super(key: key);
  final listBulan = [
    {"nom": 1, "name": "January"},
    {"nom": 2, "name": "February"},
    {"nom": 3, "name": "March"},
  ...
  Widget build(BuildContext context) {
    return Obx(() => ListView(
          ...
          children: [
                ...
                child: charts.BarChart(
                  [
                    charts.Series<ModelSalesPerformance, String>(
                      ...
                      domainFn: (ModelSalesPerformance sales, _) =>
            ...
            for (final a in Val.listSalesperformance)
              Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
